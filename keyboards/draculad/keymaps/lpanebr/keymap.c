...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNC] = LAYOUT(
        ...
        KC_F20, KC_F19, KC_F18, KC_F17, KC_COPY,                                                                   KC_F11, KC_F4, KC_F5, KC_F6, XXXXXXX,
        KC_F16, KC_F15, KC_F14, KC_F13, XXXXXXX,                                                                   KC_F10, KC_F1, KC_F2, KC_F3, XXXXXXX,
                                        XXXXXXX,                                                                   KC_NO,
    ...
    [_MUS] = LAYOUT(
        XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R,                                                               KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_ACL2,
    ...
    [_ADJ] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                                               RGB_M_R, RGB_M_SW, RGB_M_T, RGB_M_TW, _______,
                                            XXXXXXX,                                                               _______,
